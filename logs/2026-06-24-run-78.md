...
- Reconfirmed `VALIDATION_STATUS.md` closure boundaries: pending implemented items must not be moved to **Done** until latest `main` passes local `npm run ci` and evidence is recorded.
